      ...
      return (
        <>
          ...
          <SidebarItem
            ...
            label="Quản lý học sinh"
            collapsed={isCollapsed}
            active={path === "/management/admin/students"}
          />
          <SidebarItem
            to="/management/admin/classes"
            icon={faGraduationCap}
            label="Quản lý lớp học"
            collapsed={isCollapsed}
            active={path === "/management/admin/classes"}
          />
          <SidebarItem
            to="/management/admin/partners"
            icon={faBuilding}
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between py-4 px-6 text-xl font-bold border-b border-white/30">
        {!isCollapsed && (
          <span className="lg:block hidden">Hệ thống quản lý</span>
        )}
