      ...
      {sidebarOpen && (
        <div className="p-4 border-t border-blue-100 bg-white/80 backdrop-blur-sm space-y-3">
            ...
            {loadingProfile ? (
              ...
              <div className="flex items-center space-x-3 cursor-pointer" onClick={() => navigate("/settings")}>
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-semibold text-black-900 text-sm truncate">
          ...
          <button
            ...
            className="cursor-pointer w-full flex items-center space-x-3 px-4 py-3 rounded-xl text-left transition-all duration-200 text-red-600 hover:bg-red-50 hover:shadow-md hover:transform hover:scale-[1.01] group border border-red-100 hover:border-red-200"
          >
            <LogOut
              size={20}
